...
for itrThr = 30 : 30
  ...
  for stopThr = 19 : 19
    ...
    ml_outPath = ["../plots/", query, "/", ssize, "/linear/missing_", num2str(opr_configurations(configuration_to_predict)), "/MLExtrapolate/40/ml_out_", num2str(itrThr), "_", num2str(stopThr), ".csv"];
