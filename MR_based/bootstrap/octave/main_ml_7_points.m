...
% The full configuration vector is inverted and scaled.
%[ml_full_configurations_scaled, conf_mu, conf_sigma] = zscore(1 ./ full_configurations);
...
for itrThr = 30 : 30
  ...
  for stopThr = 19 : 19
    ...
    ml_outPath = ["../plots/", query, "/", ssize, "/linear/missing_", num2str(opr_configurations(configuration_to_predict)), "/MLInterpolate/7_points/ml_out_", num2str(itrThr), "_", num2str(stopThr), ".csv"];
