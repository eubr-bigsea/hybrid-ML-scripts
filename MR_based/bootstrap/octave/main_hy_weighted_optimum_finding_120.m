...
filepath = ["../plots/R1/250/linear/missing_120/baseR1.eps"];
  x = full_configurations;
plot(x, sim_results,'--db', x, avg_time_query_vector, ':*g');
...
for itrThr = 25 : 40
  ...
  for stopThr = 15 : 30
    ...
    outPath = ["../plots/", query, "/", ssize, "/linear/missing_", num2str(opr_configurations(configuration_to_predict)), "/HyOptimumFinding/out_", num2str(itrThr), "_", num2str(stopThr), ".csv"];
