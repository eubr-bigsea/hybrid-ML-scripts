...
for itrThr = 35:37
  ...
  for stopThr = 15:30
    ...
    ml_outPath = ["../plots/", query, "/", ssize, "/linear/missing_", num2str(opr_configurations(configuration_to_predict)), "/MLOptimumFinding/ml_out_", num2str(itrThr), "_", num2str(stopThr), ".csv"];
