...
for itrThr = 26:26
  ...
  for stopThr = 15:15
    ...
    ml_outPath = ["../plots/", query, "/", ssize, "/linear/missing_", num2str(opr_configurations(configuration_to_predict)), "/MLExtrapolate/15/ml_out_", num2str(itrThr), "_", num2str(stopThr), ".csv"];
